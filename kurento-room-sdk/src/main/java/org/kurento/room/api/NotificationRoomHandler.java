...
public interface NotificationRoomHandler extends RoomHandler {
   ...
   * {@link NotificationRoomManager#joinRoom(String, String,String,int, boolean,
          boolean, ParticipantRequest)} . The new
   ...
   */
  void onParticipantJoined(ParticipantRequest request, String roomName ,String newUserName,int plat,
      Set<UserParticipant> existingParticipants, RoomException error);

  /**
   * Called as a result of
   * {@link NotificationRoomManager#leaveRoom(ParticipantRequest)} . The user should
  ...
  /**
   * Called as a result of {@link NotificationRoomManager#evictParticipant(String,String)}
  ...
  /**
   * Called as a result of
   * {@link NotificationRoomManager#publishMedia(ParticipantRequest, String, boolean, MediaElement...)} . The
