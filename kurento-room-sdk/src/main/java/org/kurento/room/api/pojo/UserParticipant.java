...
public class UserParticipant {
  ...
  private int plat = 0; // 0 for pc , 1 for mac , 2 for iOS, 3 for adr , 4 for linux , 5 for web

  public UserParticipant(String participantId, String userName, boolean streaming) {
    this(participantId,userName,streaming,0);
  }

  public UserParticipant(String participantId, String userName, boolean streaming,int plat) {
    super();
