 ...
 */
@RestController
public class PCConferenceController {

  private static final Logger log = LoggerFactory.getLogger(PCConferenceController.class);

  private final static boolean DEMO_LOOPBACK_REMOTE = Config.LOOPBACK_REMOTE;
  private final static boolean DEMO_LOOPBACK_AND_LOCAL = Config.LOOPBACK_ANDLOCAL;
